...
class MY_Controller extends CI_Controller {
    ...
    protected function _portal_front($view, $data) {
        $this->load->view('components/header',$data);
        $this->load->view('components/nav_portal',$data);
        $this->load->view($view, $data);
        $this->load->view('components/footer_portal');
    }

        protected function _view_fron($view, $data) {
        $this->load->view('components/header',$data);
        $this->load->view($view, $data);
        $this->load->view('components/footer');
    }
